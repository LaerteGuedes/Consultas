                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="panel panel-default profissional">
                                ...
                                <ul class="list-group default">
                                    ...
                                    <li class="list-group-item">
                                        Profissionais em período de avaliação <span class="destaque">100</span>
                                    </li>
                                    <li class="list-group-item">
                                    ...
                                    <li class="list-group-item">
                                        Nº de assinaturas mensais <span class="destaque">25 <i>(R$ 1.000,00)</i></span>
                                    </li>
                                    <li class="list-group-item">
                                        Nº de assinaturas semestrais <span class="destaque">50 <i>(R$ 10.500,00)</i></span>
                                    </li>
                                    <li class="list-group-item">
                                        Nº de assinaturas anuais <span class="destaque">50 <i>(R$ 18.000,00)</i></span>
                                    </li>
                                    <li class="list-group-item">
